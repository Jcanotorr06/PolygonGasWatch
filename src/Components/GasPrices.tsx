...
import {faRocket, faPlane, faCar, faBicycle} from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <Container maxWidth="xl">
            ...
            <Stack  spacing={2} justifyContent="space-around" direction={{xs: 'column', md: 'row'}} >
                ...
                <PriceBox spacing={{xs: 2 ,md:6}} justifyContent={{xs: 'space-between', md: 'initial'}} alignItems={{xs: 'center', md: 'initial'}} direction={{xs: 'row', md: 'column'}} textAlign="center" borderColor='#8247E5' width={{md: "100%"}} borderRadius={{md: "10%"}} height={{xs: 50, md: 250}}>
                    <Box display="flex" justifyContent="center" alignItems="center" >
                        <Box color="#8247E5" padding="0.5rem" marginRight="0.5rem" bgcolor="rgba(130, 71, 229, 0.2)" display="inline-block" borderRadius="100%" >
                    ...
                    <Typography variant="subtitle1" color="#9C9C9C">
                        ${(((21000*gasData.fast)/1000000000)*gasData.price).toFixed(6)} | ~1 Minute
                    </Typography>
                </PriceBox>

                <PriceBox spacing={{xs: 2 ,md:6}} justifyContent={{xs: 'space-between', md: 'initial'}} alignItems={{xs: 'center', md: 'initial'}} direction={{xs: 'row', md: 'column'}} textAlign="center" borderColor='#B9B9B9' width={{md: "100%"}} borderRadius={{md: "10%"}} height={{xs: 50, md: 250}}>
                    <Box display="flex" justifyContent="center" alignItems="center" >
                        <Box color="#0400E0" padding="0.5rem" marginRight="0.5rem" bgcolor="rgba(4, 0, 224, 0.2)" display="inline-block" borderRadius="100%" >
                    ...
                    <Typography variant="subtitle1" color="#9C9C9C">
                        ${(((21000*gasData.standard)/1000000000)*gasData.price).toFixed(6)} | ~3 Minutes
                    </Typography>
                </PriceBox>

                <PriceBox spacing={{xs: 2 ,md:6}} justifyContent={{xs: 'space-between', md: 'initial'}} alignItems={{xs: 'center', md: 'initial'}} direction={{xs: 'row', md: 'column'}} textAlign="center" borderColor='#B9B9B9' width={{md: "100%"}} borderRadius={{md: "10%"}} height={{xs: 50, md: 250}}>
                    <Box display="flex" justifyContent="center" alignItems="center" >
                        <Box color="#E40000" padding="0.5rem" marginRight="0.5rem" bgcolor="rgba(228, 0, 0, 0.2)" display="inline-block" borderRadius="100%" >
                    ...
                    <Typography variant="subtitle1" color="#9C9C9C">
                        ${(((21000*gasData.safeLow)/1000000000)*gasData.price).toFixed(6)} | &#62;10 Minutes
                    </Typography>
                </PriceBox>
            ...
            <Box marginTop={2}>
                <Typography textAlign="center" variant="subtitle1" color="#9C9C9C" >Updates Every <strong>10 Seconds</strong></Typography>
            </Box>
        </Container>
    )
}
